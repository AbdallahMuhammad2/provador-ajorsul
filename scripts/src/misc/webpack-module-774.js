...
function webpackModule774(d, o, c) {
...
export default webpackModule774;
...
export function executeModule(moduleRegistry, globalScope = {}) {
    ...
    try {
        webpackModule774.call(globalScope, moduleObj, moduleObj.exports, require);
        return moduleObj.exports;
    } catch (error) {
        console.error('Error executing module 774:', error);
        return {};
    }
}
