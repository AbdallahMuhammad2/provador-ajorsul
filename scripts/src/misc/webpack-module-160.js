...
function webpackModule160(d, o, c) {
...
export default webpackModule160;
...
export function executeModule(moduleRegistry, globalScope = {}) {
    ...
    try {
        webpackModule160.call(globalScope, moduleObj, moduleObj.exports, require);
        return moduleObj.exports;
    } catch (error) {
        console.error('Error executing module 160:', error);
        return {};
    }
}
